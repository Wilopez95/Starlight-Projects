...
export const mapPtWorkOrderForCompletion = ({ mediaFiles = [], ...workOrder }) => ({
  ...workOrder,
...
export const mapPtOrderForCompletion = ({
  material = {},
  billableService = {},
  project = {},
  promo = {},
  ...
  return {
    ...
    workOrder: mapPtWorkOrderForCompletion(
      pick([
        'id',
        'woNumber',
...
export const mapDetailsToPtOrderCompletionInput = details =>
  mapPtOrderForCompletion(
    pick([
      'noBillableService',
      'applySurcharges',
      'action',
...
export const mapRoWorkOrderForCompletion = ({ mediaFiles = [], ...workOrder }) => ({
  ...workOrder,
  mediaFiles: mediaFiles.map(pick(['url', 'timestamp', 'author', 'fileName'])),
...
export const mapRoOrderForCompletion = ({
  material = {},
  billableService = {},
  project = {},
  promo = {},
  ...
  return {
    ...
    workOrder: mapRoWorkOrderForCompletion(
      pick([
        'id',
        'woNumber',
        'pickedUpEquipmentItem',
...
export const mapDetailsToRoOrderCompletionInput = details =>
  mapRoOrderForCompletion(
    pick([
      'noBillableService',
      'applySurcharges',
      'action',

...
exports.updateOrderRequestSchema = exports.createOrderRequestSchema = void 0;
const Joi = require("joi");
let id = Joi.number().integer().positive();
exports.createOrderRequestSchema = Joi.object()
    .keys({
    ...
    .required();
exports.updateOrderRequestSchema = Joi.object()
    .keys({

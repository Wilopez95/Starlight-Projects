...
@Check(
  `"equipment_type" in ('rolloff_container', 'waste_container', 'portable_toilet', 'unspecified', 'multiple')`,
)
...
export class Subscriptions {
  ...
  // @ManyToOne((target) => CustomRatesGroupsHistorical, (t) => t.id)
  // @JoinColumn({ name: "custom_rates_group_id" })
  // subscriptionsCustomRatesGroupIdFK: CustomRatesGroupsHistorical;

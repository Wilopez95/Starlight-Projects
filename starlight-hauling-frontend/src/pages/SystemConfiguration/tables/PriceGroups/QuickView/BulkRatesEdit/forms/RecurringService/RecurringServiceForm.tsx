...
const RecurringServiceForm: React.FC<IRecurringServiceForm> = ({
  ...
  const materialsNavigation: NavigationConfigItem<string>[] = sortedMaterials.map(
    (material, index) => ({
  ...
  const equipmentItemsNavigation: NavigationConfigItem<string>[] = sortedEquipmentItems.map(
    (equipmentItem, index) => ({
  ...
  useEffect(() => {
    (async () => {
      if (
        ...
        const recurringServicesFrequencies = fetchedFrequencies
          ...
          .map((frequencies, index) => ({
            ...recurringServicesValues[index],
            frequencies,
          }));

        recurringServicesFrequencies && setRecurringServices(recurringServicesFrequencies);

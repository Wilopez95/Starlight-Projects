...
import { IRecurrentOrderTemplateResolver } from '../../Interfaces/RecurrentOrderTemplate';
import priceGroupType from '../priceGroup/type';
import priceType from '../prices/type';

const recurrentOrderTemplateType: GraphQLObjectType = new GraphQLObjectType({
  name: 'recurrentOrderTemplate',
  description: 'display every recurrent order template on the system',
  fields: () => ({
    ...
    price_group: {
      type: priceGroupType,
      resolve: (priceGroup: IRecurrentOrderTemplateResolver) => {
    ...
    prices: {
      type: priceType,
      resolve: (price: IRecurrentOrderTemplateResolver) => {
...
export default recurrentOrderTemplateType;

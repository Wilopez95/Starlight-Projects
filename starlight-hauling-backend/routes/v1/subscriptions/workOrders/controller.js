...
export const editSubscriptionWorkOrderById = async ctx => {
  ...
  try {
    ...
    const serviceOrderDetails = await SubscriptionOrderRepo.getInstance(
      ctx.state,
    ).getDetailsForRoutePlanner(
      {
    ...
    await syncToDispatch(ctx, {
      ...
      subscriptionWorkOrderDetails: serviceOrderDetails,
    });
...
export const changeWorkOrderStatus = async ctx => {
  ...
  try {
    ...
    //   {
    //     serviceItemId: subscriptionOrder.subscriptionServiceItemId,
    const serviceItemDetails = await SubscriptionOrderRepo.getInstance(
      ctx.state,
    ).getDetailsForRoutePlanner(
      {
        orderId: subscriptionOrder.id,

...
export const createCustomRatesGroupsSchema = Joi.object()
  .keys({
    ...
    serviceAreaIds: Joi.array().items(Joi.number().integer().optional()).min(1).optional(),
  })
  .required();

export const updateCustomRatesGroupsSchema = Joi.object()
  .keys({

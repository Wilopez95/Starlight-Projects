...
export const billingUpdateCustomerCc = (
  {
    input: { customerId, id, data } = defaultInput,
    output = defaultOutput,
    status = defaultStatus,
  } = {},
  baseUrl = BASE_URL,
) => nock(baseUrl).patch(`/customers/${customerId}/credit-cards/${id}`, data).reply(status, output);

export default billingUpdateCustomerCc;

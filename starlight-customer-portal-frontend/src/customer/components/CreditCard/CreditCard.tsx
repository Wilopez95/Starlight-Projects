...
import tableQuickViewStyles from '@root/core/common/TableTools/TableQuickView/css/styles.scss';
import {
  cardPrefixes14,
  cardPrefixes15,
  ...
  defaultCardMask,
  months,
} from '@root/core/consts';
import { buildPath } from '@root/core/helpers';
  ...
  return (
    <>
      ...
      <div className={tableQuickViewStyles.row}>
        ...
        <Layouts.Flex
          alignItems='flex-end'
          className={cx(tableQuickViewStyles.half, tableQuickViewStyles.spaceLeft)}
        >
          ...
          <Layouts.Margin bottom='4' as={Typography} fontWeight='bold' color='secondary'>
            /
          </Layouts.Margin>
          <div className={cx(tableQuickViewStyles.half, tableQuickViewStyles.spaceLeft)}>
            <Select

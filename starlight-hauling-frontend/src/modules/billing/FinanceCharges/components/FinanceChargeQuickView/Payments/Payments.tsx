...
const PaymentsTab: React.FC = () => {
  ...
  return (
    <Table>
      ...
      <TableBody loading={loading} cells={5} noResult={currentFinCharge.payments.length === 0}>
        {currentFinCharge.payments.map(payment => {
          const paymentUrl = pathToUrl(Paths.CustomerModule.PaymentsAndStatements, {
            customerId: currentFinCharge.customer!.id,

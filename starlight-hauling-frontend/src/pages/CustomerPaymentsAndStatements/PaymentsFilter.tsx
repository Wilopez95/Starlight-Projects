...
import { IBaseFilterComponent, PaymentInvoicedStatus } from '@root/types';

const invoicedStatusOptions: ISelectOption[] = [
  {
    label: 'Applied',
    value: PaymentInvoicedStatus.APPLIED,
  },
  {
    label: 'Unapplied',
    value: PaymentInvoicedStatus.UNAPPLIED,
  },
  {
    label: 'Reversed',
    value: PaymentInvoicedStatus.REVERSED,
  },
];
...
const PaymentsFilter: React.FC<IBaseFilterComponent> = ({ onApply }) => {
  ...
  return (
    <TableFilter onApply={onApply}>
      ...
      <TableFilterConfig
        label={t(`${I18N_PATH}InvoicedStatus`)}
        filterByKey="filterByInvoicedStatus"
      >
        <MultiSelectFilter options={invoicedStatusOptions} />
      </TableFilterConfig>
      ...
      <TableFilterConfig label={t(`${I18N_PATH}UnappliedAmount`)} filterByKey="filterByUnapplied">
        <NumberRangeFilter
          fromNumberPropName="filterByUnappliedFrom"
          toNumberPropName="filterByUnappliedTo"
          unit={currencySymbol}
        />
      </TableFilterConfig>
...
export default observer(PaymentsFilter);

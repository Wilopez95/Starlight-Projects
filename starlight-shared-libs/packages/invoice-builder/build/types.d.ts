...
export declare type PaymentTerms = 'cod' | 'net15Days' | 'net30Days' | 'net60Days';
export declare type InvoiceConstruction = 'byOrder' | 'byAddress' | 'byCustomer';
...
export declare type CreditCardType = 'MC' | 'VISA' | 'DSCV' | 'UNKN' | 'AMEX' | 'WEX' | 'VYGR' | 'TEL' | 'DNR' | 'JCB' | 'BML' | 'RM';

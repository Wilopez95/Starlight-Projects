declare module 'printnode-ws-http-client';
...
declare namespace PrintNodeClient {
  ...
  class WebSocket {
    ...
    subscribe(
      topic: string | string[],
      fn: (authData: AuthData | ErrorResponse) => void | Promise<void>,
      options?: SubscribeOptions,
    ): this;
    unsubscribe(fnOrTopic: (() => void | Promise<void>) | string): number;
    removeServerSubscription(id: number): number;
    getScales(
      options: ScaleParams,
      callback: (message: ScaleResponse) => void | Promise<void>,
      ctx?: any,
    ): number;
    getComputerConnections(options: ScaleParams, callback: () => void, ctx?: any): number;
    closeSocket(): void;
  }

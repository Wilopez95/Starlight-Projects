...
let subscriptionsServiceType = new graphql_1.GraphQLObjectType({
    ...
    fields: () => ({
        ...
        service_days_of_week: { type: graphql_scalars_1.GraphQLJSON },
        quantity: { type: graphql_1.GraphQLInt },
        override_price: { type: new graphql_1.GraphQLNonNull(graphql_1.GraphQLBoolean) },
        override_proration: { type: new graphql_1.GraphQLNonNull(graphql_1.GraphQLBoolean) },
...
exports.default = subscriptionsServiceType;

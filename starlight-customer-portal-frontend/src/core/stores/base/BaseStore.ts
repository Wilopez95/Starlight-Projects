...
import { ApiError } from '@root/core/api/base/ApiError';
import { baseSort } from '@root/core/helpers';
...
export abstract class BaseStore<T extends BaseEntity> {
  ...
  @action updateSelectedEntity(newEntity: T) {

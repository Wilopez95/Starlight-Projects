...
export class CustomRatesGroupsHistorical {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @Column({ type: 'text', nullable: false, default: 'material', name: 'dump_setting' })
  dumpSetting: string;

  @Column({ type: 'text', nullable: false, default: 'material', name: 'load_setting' })
  loadSetting: string;
  ...
  @Column({ type: 'timestamp without time zone', default: null, name: 'end_date' })
  endDate: Date;
}

...
export const mapPtWorkOrderForFinalization = ({ mediaFiles = [], ...workOrder }) => ({
  ...workOrder,
...
export const mapPtOrderForFinalization = ({
  material = {},
  billableService = {},
  project = {},
  promo = {},
  ...
  return {
    ...
    workOrder: mapPtWorkOrderForFinalization(
      pick([
        'id',
        'woNumber',
...
export const mapDetailsToPtOrderFinalizationInput = details =>
  mapPtOrderForFinalization(
    pick([
      'noBillableService',
      'applySurcharges',
      'action',
...
export const mapRoWorkOrderForFinalization = ({ mediaFiles = [], ...workOrder }) => ({
  ...workOrder,
  mediaFiles: mediaFiles.map(pick(['url', 'timestamp', 'author', 'fileName'])),
...
export const mapRoOrderForFinalization = ({
  material = {},
  billableService = {},
  project = {},
  promo = {},
  ...
  return {
    ...
    workOrder: mapRoWorkOrderForFinalization(
      pick([
        'id',
        'woNumber',
        'pickedUpEquipmentItem',
...
export const mapDetailsToRoOrderFinalizationInput = details =>
  mapRoOrderForFinalization(
    pick([
      'noBillableService',
      'applySurcharges',
      'action',

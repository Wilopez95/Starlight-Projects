...
import { i18n } from '@root/core/i18n';
import { Languages, languages } from '@root/core/i18n/config/language';
import { i18nRegionLocalStorageKey, Regions, regions } from '@root/core/i18n/config/region';
import { getLanguageList, isAPartOfEnum } from '@root/core/i18n/helpers';
import { ILanguageConfig, IntlConfig, IRegionConfig } from '@root/core/i18n/types';
...
export class I18nStore {
  ...
  @computed
  get regionConfig(): IRegionConfig {
    return regions.get(this.region) as IRegionConfig;
  }

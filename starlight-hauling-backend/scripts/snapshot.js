...
import writeSnapshots from '../db/writeSnapshots.js';
import { getAllTablesAndColumnsBySchema } from '../utils/dbMetadata.js';
...
yargs(hideBin(process.argv))
  ...
  .command(
    ...
    async args => {
      const tables = await getAllTablesAndColumnsBySchema(knex, args.schema);
      knex.destroy();
      ...
      const path = `${process.cwd()}/${args.output}`;

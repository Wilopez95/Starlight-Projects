...
import {
  ...
  getJobSiteData,
  getBillableServiceBySubscription,
} from './controller.js';
...
router.use('/independent-work-order-media', authorized(), workOrdersMediaRouter);
router.use('/invoicing', orderInvoicingRoutes);
router.use('/work-orders/:woNumber', authorized(), workOrderRoutes);
router.use('/:id', authorized(), orderFlowRoutes);
...
router.get('/jobSiteData', getJobSiteData);

router.get('/billableServiceBySubscription', getBillableServiceBySubscription);
...
router.get('/requests', authorized(), validate(paginationParams, 'query'), getOrderRequests);
router.get('/requests/count', authorized(), getOrderRequestsCount);
router.get('/requests/:id', authorized(), getOrderRequestById);
router.patch('/requests/:id', authorized(), rejectOrderRequest);
...
router.post('/media/:independentWorkOrderId', authorized(), createIndependentWorkOrderMedia);

...
import { FieldDefinitionNode, EnumTypeDefinitionNode, InputValueDefinitionNode, GraphQLSchema, ObjectTypeDefinitionNode, InterfaceTypeDefinitionNode, TypeNode, InputObjectTypeDefinitionNode, TypeDefinitionNode, UnionTypeDefinitionNode } from 'graphql';
...
export declare class TypeGraphQLVisitor<TRawConfig extends TypeGraphQLPluginConfig = TypeGraphQLPluginConfig, TParsedConfig extends TypeGraphQLPluginParsedConfig = TypeGraphQLPluginParsedConfig> extends TsVisitor<TRawConfig, TParsedConfig> {
    ...
    UnionTypeDefinition(node: UnionTypeDefinitionNode, key: any, parent: any): string;

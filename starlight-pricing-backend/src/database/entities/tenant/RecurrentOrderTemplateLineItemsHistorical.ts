...
export class RecurrentOrderTemplateLineItemsHistorical {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @Column({ type: 'int4', nullable: true, name: 'recurrent_order_template_id' })
  ...
  @Column({ type: 'int4', nullable: true, name: 'price_id' })
  priceId: number;
}
